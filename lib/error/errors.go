...
var (
	...
	ErrorUnfreezingFromInvalidAccount              = NewError(153, "unfreezing should be done from a frozen account")
	ErrorUnfreezingToInvalidLinkedAccount          = NewError(154, "unfreezing should be done to a valid linked account")
	ErrorUnfreezingNotReachedExpiration            = NewError(155, "unfreezing should pass 241920 blockheight from unfreezing request")
	ErrorFrozenAccountMustCreatedFromLinkedAccount = NewError(156, "frozen account create-transaction must be generated from the linked account")
	ErrorUnfreezingRequestNotRequested             = NewError(157, "unfreezing must be generated after the unfreezing request")
)
